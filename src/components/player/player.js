...
class Player extends Component {
  ...
  deleteClick = (id, index) => {
    ...
    if (
      ...
      list.length === this.props.currentIndex
    ) {
      currentIndex--
      ...
      <div className="player">
        ...
        >
          <div
            className="player-bg"
            style={{
              backgroundImage: `url(${currentMusic.image}?param=200y200)`
            }}
          />
          ...
          <div className="footer">
            <div className="progress-wrapper">
              <span className="progress-time progress-time-l">
                {formatTime(currentTime)}
              </span>
              <Progress
                percent={currentTime / currentMusic.duration}
                dragEnd={this.progressEnd}
              />
              <span className="progress-time progress-time-r">
            ...
            <div className="btn-wrapper">
              ...
              <div
                className={classNames('btn btn-play', { 'btn-pause': !isPlay })}
                onClick={this.play}
              />
        ...
        >
          <div className="player-min-img">
            <img
              src={`${currentMusic.image}?param=100y100`}
              alt=""
              width="100%"
              height="100%"
            />
          ...
          <div
            className={classNames('player-min-play', { pause: !isPlay })}
            onClick={this.play}
          />
